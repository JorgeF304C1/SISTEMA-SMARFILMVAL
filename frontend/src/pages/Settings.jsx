  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 1fr) minmax(300px, 1fr)', gap: '32px' }}>
        ...
        <div style={{ marginBottom: '24px' }}>
          <label style={{ display: 'block', marginBottom: '8px', fontWeight: 'bold' }}>Costo de Material Base ($/ml)</label>
          <p style={{ fontSize: '12px', color: 'var(--text-muted)', marginBottom: '8px' }}>El costo predeterminado por metro lineal de bobina consumida.</p>
          <input
            type="number"
            step="0.01"
            required
            value={settings.default_base_cost_per_ml}
            onChange={e => setSettings({...settings, default_base_cost_per_ml: parseFloat(e.target.value)})}
            style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', color: 'white' }}
          />
        </div>
